            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown">
                    <a href="#" class="header-icon flag-icon" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{ URL::asset('assets/img/flag/flag-01.png') }}" alt="Language"
                            class="img-fluid rounded-pill">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right p-3">
                        <a href="javascript:void(0);" class="dropdown-item active d-flex align-items-center">
                            <img class="me-2 rounded-pill" src="{{ URL::asset('assets/img/flag/flag-01.png') }}"
                                alt="Img" height="22" width="22"> English
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">
                            <img class="me-2 rounded-pill" src="{{ URL::asset('assets/img/flag/flag-02.png') }}"
                                alt="Img" height="22" width="22"> French
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">
                            <img class="me-2 rounded-pill" src="{{ URL::asset('assets/img/flag/flag-03.png') }}"
                                alt="Img" height="22" width="22"> Spanish
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">
                            <img class="me-2 rounded-pill" src="{{ URL::asset('assets/img/flag/flag-04.png') }}"
                ...
                <div class="provider-head-links">
                    <a href="{{ url('admin/chat') }}"
                        class="d-flex align-items-center justify-content-center header-icon active-dot">
                        <i class="ti ti-message fs-16"></i>
                    </a>
                </div>
                <div class="provider-head-links">
                    <a href="javascript:void(0);"
                        class="d-flex align-items-center justify-content-center dropdown-toggle header-icon active-dot"
                            ...
                            <div class="d-flex flex-column">
                                    ...
                                    <a href="javascript:void(0);">
                                        <div class="d-flex">
                                            <span class="avatar avatar-lg me-2 flex-shrink-0">
                                                <img src="{{ URL::asset('assets/img/profiles/avatar-52.jpg') }}"
                                                    alt="Profile" class="rounded-circle">
                                            </span>
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center">
                                                    <p class="mb-1 w-100"><span class="text-dark fw-semibold">Stephan
                                                            Peralt</span>
                                ...
                                <div class="border-bottom mb-3 pb-3">
                                    <a href="javascript:void(0);" class="pb-0">
                                        <div class="d-flex">
                                            <span class="avatar avatar-lg me-2 flex-shrink-0">
                                                <img src="{{ URL::asset('assets/img/profiles/avatar-36.jpg') }}"
                                                    alt="Profile" class="rounded-circle">
                                            </span>
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center">
                                                    <p class="mb-1 w-100"><span class="text-dark fw-semibold">Harvey
                                                            Smith</span>
                                ...
                                <div class="border-0 mb-3 pb-0">
                                    <a href="javascript:void(0);">
                                        <div class="d-flex">
                                            <span class="avatar avatar-lg me-2 flex-shrink-0">
                                                <img src="{{ URL::asset('assets/img/profiles/avatar-22.jpg') }}"
                                                    alt="Profile" class="rounded-circle">
                                            </span>
                                            <div class="flex-grow-1">
